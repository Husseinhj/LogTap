...
```gradle
debugImplementation 'com.github.Husseinhj.LogTap:logtap:v0.14.0'
releaseImplementation 'com.github.Husseinhj.LogTap:logtap-noop:v0.14.0'
```
...
```gradle
dependencies {
    devDebugImplementation 'com.github.Husseinhj.LogTap:logtap:v0.14.0'
    devReleaseImplementation 'com.github.Husseinhj.LogTap:logtap-noop:v0.14.0'
}
```
